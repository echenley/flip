...
(function(React) {
        ...
        render: function() {
            ...
            return (
                React.DOM.div({id: "game-container"}, 
                    ...
                    React.DOM.div({id: "game-board-wrapper", className: wrapperClasses}, 
                        GameBoard({
    ...
    var BoardFace = React.createClass({displayName: 'BoardFace',
        render: function() {
            ...
            return (
                React.DOM.div({id: this.props.id, className: this.props.classes}, 
    ...
    var Tile = React.createClass({displayName: 'Tile',
        ...
        render: function() {
            return (
                /* jshint ignore:start */
                React.DOM.div({className: this.getTileClassOf(this.props.tileText), style: this.props.tileSize})
                /* jshint ignore:end */
            );
        }
    });
