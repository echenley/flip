...
(function(React,zoom) {
        ...
        render: function() {
            ...
            return (
                <div id="game-container">
                    ...
                    <div id="game-board-wrapper" style={this.state.boardDimensions} className={wrapperClass} onClick={this.toggleZoom}>
                        <GameBoard
    ...
    var Player = React.createClass({
        ...
        render: function() {
            ...
            return (
                <div ref="player" className={playerClass} id="player" style={playerStyle}></div>
            );
            /* jshint ignore:end */
        }
    });
